...
import { AstNode, IAddOperatorAstContent, IAssignableValueAstContent, IBooleanAstContent, IDeclarationAstContent, IFnAddExprAstContent, IFnArgAstContent, IFnAssignLOAstContent, IFnAssignStatementAstContent, IFnAstContent, IFnAtomicExprAstContent, IFnBlockStatementAstContent, IFnBodyAstContent, IFnCallAstContent, IFnConditionStatementAstContent, IFnMacroConditionAstContent, IFnMacroConditionBranchAstContent, IFnMacroDefineAstContent, IFnMacroIncludeAstContent, IFnMultiplicationExprAstContent, IFnRelationExprAstContent, IFnReturnStatementAstContent, IFnReturnTypeAstContent, IFnVariableAstContent, IFnVariableDeclarationAstContent, IMultiplcationOperatorAstContent, INumberAstContent, IPassPropertyAssignmentAstContent, IPropertyAstContent, IPropertyItemAstContent, IRelationOperatorAstContent, IRenderStateDeclarationAstContent, IStatePropertyAssignAstContent, IStructAstContent, ITagAssignmentAstContent, ITagAstContent, ITupleNumber2, ITupleNumber3, ITupleNumber4, IVariableTypeAstContent } from "./types";
...
export declare class VariableDeclarationAstNode extends AstNode<IFnVariableDeclarationAstContent> {
    _doSerialization(context: RuntimeContext, opts?: {
        global: boolean;
    }): string;
}
